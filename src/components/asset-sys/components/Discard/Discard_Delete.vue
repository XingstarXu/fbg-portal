          ...
          <template v-slot:body>
             <b-container>
               <b-row>
                 ...
                 <b-col  lg="8">
                   <h6>是否確認刪除{{deleteData.code}}報銷單？</h6>
                 </b-col>
               </b-row>
               <b-row>
...
export default {
  ...
  data(){
    return{
      ...
      isDisabled:false,
      deleteData:{discard_header_id:"", discard_code:""}
    ...
    saveData(){
      ...
      setData(deleteRow){
            //editRow.vendor_id.replace(/-/g,''),
                this.deleteData={
                                discard_header_id: deleteRow.item.header.discard_header_id,
                                discard_code: deleteRow.item.header.discard_code,
                              };
          }      
  ...
  mounted(){
    this.$refs.child.modal_titel="取消報銷單"
